...
#						           #
####################################
DATA_N=1000  # only validation purpose
...
#						        #
#################################################
echo "$PYTHON \"run_exp_syn_custom.py\" \'gen_noise\'"
$PYTHON "run_exp_syn_custom.py" 'gen_noise'
#########################################################
#						                                #
...
#						                                #
#########################################################
echo "Rscript --vanilla \"$R_SRC_DIR/${DATA_FLAG}_${MODEL_FLAG}.R\" $R_DATA_DIR $DATA_TRIAL_N"
